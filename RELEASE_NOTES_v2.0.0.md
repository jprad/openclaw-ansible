...
```bash
curl -fsSL https://raw.githubusercontent.com/clawdbot/openclaw-ansible/main/install.sh | bash
```

#### Development Mode
```bash
git clone https://github.com/clawdbot/openclaw-ansible.git
cd openclaw-ansible
...
**Full Changelog**: https://github.com/clawdbot/openclaw-ansible/blob/main/CHANGELOG.md
